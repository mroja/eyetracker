...
private slots:
    ...
    void privGazeData(QPointF right, QPointF left, double timestamp);
...
signals:
    ...
    void gazeData(QPointF, QPointF, double);
...
private:
                                                ...
                                                void * user_data)
    {
        if(user_data)
        {
            ...
            reinterpret_cast<EyetrackerEventLoopWorker *>(user_data)->
                emit_gaze_data(gazedata,
                               extensions,
                        ...
                        double timestamp)
    {
        ...
        emit gazeData(right, left, timestamp);
    }
