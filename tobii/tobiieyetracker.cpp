...
void TobiiEyetracker::initialize()
{
    ...
    connect(worker, SIGNAL(gazeData(QPointF,QPointF,double)), this, SLOT(privGazeData(QPointF,QPointF,double)));
...
void TobiiEyetracker::privGazeData(QPointF right, QPointF left, double timestamp)
{
    emitNewPoint(calculateSinglePoint(right, left), timestamp);
}
