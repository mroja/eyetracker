...
PupilDetectingFrameReceiver::PupilDetectingFrameReceiver(QObject * parent)
    : FrameReceiver(parent)
{
}

void PupilDetectingFrameReceiver::loadSettings(QSettings & settings)
{
...
void PupilDetectingFrameReceiver::saveSettings(QSettings & settings) const
{
...
void PupilDetectingFrameReceiver::processFrame(cv::Mat & frame, qint64 timestamp)
{
    if(m_mirrored)
...
PupilDetectingFrameReceiver::PupilDetectionResult
PupilDetectingFrameReceiver::detect(const cv::Mat & frame,
                                    cv::Mat & drawFrame)
{
    cv::Mat tmp;
    frame.copyTo(tmp);
