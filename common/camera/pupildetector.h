...
class PupilDetectingFrameReceiver : public FrameReceiver
{
    Q_OBJECT
...
public:
    ...
    explicit PupilDetectingFrameReceiver(QObject * parent = 0);
...
signals:
    void pupilData(bool, double, double, double, qint64);

private:
    void processFrame(cv::Mat & frame, qint64 timestamp) override;
