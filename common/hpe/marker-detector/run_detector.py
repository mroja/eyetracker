...
if __name__ == '__main__':
    ...
    i_p = CamImageProvider(CAMERA_INDEX, p_width=640, p_height=480)
    m = Square(MARKER_ID)
    img = i_p.next()
    ...
    while cv.WaitKey(1) != 27:
        ...
        t_ms = int((t * 1000.0) + 0.5) # time in ms
        # print t_ms

        if len(markers) > 0:
            m = markers[0]
            #print 'points', m.points
            w_f, h_f = float(img.width), float(img.height)
            print '{}|{};{}|{};{}|{};{}|{};{}|{};{}'.format(
                t_ms,
                img.width, img.height,
                m.points[0][0]/w_f, m.points[0][1]/h_f,
                m.points[1][0]/w_f, m.points[1][1]/h_f,
                m.points[2][0]/w_f, m.points[2][1]/h_f,
                m.points[3][0]/w_f, m.points[3][1]/h_f
            )
